          ...
          <div className="flex h-screen flex-col items-center justify-center">
            <div className="space-y-4 text-center">
              ...
              <div className="flex justify-center items-center gap-6 mt-5">
                ...
                <a
                  href="/CV_Mael_Petit.pdf"
                  className="text-neutral-800 dark:text-neutral-300 hover:text-[#e8335a] dark:hover:text-[#f13665] transition duration-300 ease-in-out hover:scale-130"
                  aria-label="Email me"
                >
